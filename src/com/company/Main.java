...
public class Main {
    ...
    public static void main(String[] args) {
        String bible = "Genesis 1:1\tIn the beginning God created the heaven and the earth.\n" +
        ...
        String test = "God set them in the firmament of the heaven to give light upon the earth";
        //System.out.println(bible);
        System.out.println(simpleTextSearch(test.toCharArray(), bible.toCharArray()));
